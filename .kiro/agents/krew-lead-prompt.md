...
2. **Create Worktree**: Delegate to builder to run `scripts/worktree-create.sh issue-<issue-number>-$KIRO_KREW_WATCHER_PID`
...
7. **Merge**: Delegate to builder to run `scripts/worktree-merge.sh issue-<issue-number>-$KIRO_KREW_WATCHER_PID`
...
- Tag: `[attempt:4-HALT]`
- Create incident report at `.kiro-krew/specs/incidents/<task-name>-incident.md`
