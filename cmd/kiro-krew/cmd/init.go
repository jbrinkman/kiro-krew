...
var initCmd = &cobra.Command{
	Use:   "init",
	Short: "Initialize kiro-krew project structure",
	Long:  "Initialize the project with kiro-krew configuration files and directory structure.",
	RunE: func(cmd *cobra.Command, args []string) error {
		return extractTemplates("templates", ".", false)
	},
}
